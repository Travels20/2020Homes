                ...
                <form action="{{ route('admin.properties.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" name="price" id="priceValue" class="form-control" value="{{ old('price') }}" required step="0.01" placeholder="Enter price in rupees">
                             <select id="priceUnit">
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            ...
                            @if($isAdmin)
                                ...
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="checkbox" name="is_verified" id="is_verified" value="1" {{ old('is_verified', true) ? 'checked' : '' }}>
...
document.addEventListener('DOMContentLoaded', function() {
    // Price Conversion Logic - Convert Rupees to Lakhs and Crores
    const priceInput = document.getElementById('price_input');
    const priceDisplay = document.getElementById('price_display');
    const priceCrore = document.getElementById('price_crore');
    const priceLakh = document.getElementById('price_lakh');
    ...
    if (priceValue.value) {
        output.textContent =
        priceValue.value + " " + priceUnit.value;
    } else {
        output.textContent = "";
    }
    }
