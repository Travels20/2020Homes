...
@section('sidebar-menu')
    ...
    <li class="sidebar-nav-item">
        <a href="{{ route('admin.properties.index') }}" class="sidebar-nav-link active">
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="avatar bg-gradient-brand-2 text-white rounded-circle d-flex align-items-center justify-content-center me-2" style="width: 32px; height: 32px; font-size: 0.8rem;">
                                        {{ strtoupper(substr($property->user->name ?? 'A', 0, 1)) }}
                                    </div>
                                    <small class="text-dark fw-medium">{{ $property->user->name ?? 'Admin' }}</small>
                                </div>
                            </td>
                            <td class="text-end pe-4">
                                <div class="btn-group">
                                    ...
                                    <form action="{{ route('admin.properties.destroy', $property->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this property?');">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-sm btn-light text-danger border" title="Delete Property">
                        ...
                        <tr>
                            <td colspan="6" class="text-center py-5">
                                ...
                                <p class="text-secondary">Start by adding a new property to the system.</p>
