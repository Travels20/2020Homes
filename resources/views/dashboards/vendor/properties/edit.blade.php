                ...
                <form action="{{ route('vendor.properties.update', $property->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" name="price" id="price_input" class="form-control" value="{{ old('price', $property->price) }}" required step="0.01">
...
function deletePropertyImage(imageId) {
    if (confirm('Are you sure you want to delete this image?')) {
        ...
        form.method = 'POST';
        form.action = `/vendor/properties/image/${imageId}`;
