...
{
    /**
     * Display a listing of vendor's properties
     */
    public function index()
    {
        $properties = Property::where('user_id', Auth::id())->latest()->paginate(10);
        return view('dashboards.vendor.properties.index', compact('properties'));
    }
    ...
    {
        return view('dashboards.vendor.properties.create');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('dashboards.vendor.properties.edit', compact('property'));
    }
